                    ...
                    >
                      <div className="card-block">
                        <Link to={`/event/${event._id}`}>
                          <h4 class="card-title text-info">{event.name}</h4>
                        </Link>
                        <br/>
                        ...
                        <p class="card-text">
                          ...
                          <Link
                          to={`/event/${event._id}`}
                          className="btn btn-raised btn-info btn-sm text-center mt-2"
                        >
                          Read More
                        </Link>
                        </p>
                    ...
                    >
                      <div className="card-block">
                        <Link to={`/group/${post.group._id}`}>
                          <h4 class="card-title text-info">{post.group.name}</h4>
                        </Link>
                        <img
        ...
        <div>
          <div>
            ...
            <Link to={`/group/create`}>
              {" "}
              <h3>
                <span className="badge badge-info mx-auto d-block mt-4">Create A New Group!</span>
              </h3>
            </Link>
            <br />
          </div>
                  ...
                  <div key={i}>
                    ...
                    >
                      <div className="card-block">
                        ...
                        <h4 class="card-title text-info">{group.name}</h4>
          ...
          <Container>
            <Row>
              <Col>
                <div
                  className="card"
                  style={{marginTop: "10px", width: "20rem", backgroundColor:"#4C4F52" }}
                >
              ...
              <Col>
                <div
                  className="card"
                  style={{ marginTop: "10px", width: "25rem", backgroundColor:"#4C4F52"  }}
                >
