...
class Comment extends Component {
  ...
  isValid = () => {
    ...
    if (!text.length > 0) {
      ...
      this.setState({
        error: "Comment should be less than 400 characters long."
      });
      return false;
    }
    return true;
  ...
  render() {
    ...
    return (
      <div>
        <h2 className="mt-3 mb-5 ml-3">Leave a comment</h2>
                        ...
                        isAuthenticated().user._id === comment.postedBy._id && (
                          <>
                            <span
                              ...
                              className="btn btn-raised  btn-danger float-right mr-1"
                            >
                              Delete
                            </span>
                          </>
